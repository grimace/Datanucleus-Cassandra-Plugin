 ...
 * 
 */
@Ignore("Not longer valid with secondary indexing.  JDOQL tests will take care of this")
...
//			// now check our keys
//			for (Column col : keys) {
//				ObjectIdentity id = new Bytes(col.getName()).toObject(null);
...
//		List<Column> keys = selector.getSubColumnsFromRow(MetaDataUtils.INDEX_LONG, Bytes.fromUTF8("Person_LastLogin"), Bytes.fromLong(1282197146L), Selector.newColumnsPredicateAll(false, 100),
//				ConsistencyLevel.ONE);
//		
//		
//
...
//		//results for lastname
//		// p3 an p4 all have "secondName2"
//		keys = selector.getSubColumnsFromRow(MetaDataUtils.INDEX_LONG, Bytes.fromUTF8("Person_LastLogin"),  Bytes.fromLong(1282197946L), Selector.newColumnsPredicateAll(false, 100),
//				ConsistencyLevel.ONE);
//	
//		assertEquals(2, keys.size());
//
...
//		//results for lastname
//		// p3 an p4 all have "secondName2"
//		keys = selector.getSubColumnsFromRow(MetaDataUtils.INDEX_LONG, "Person_LastLogin",  ByteConverter.getBytes(1282197946L), Selector.newColumnsPredicateAll(false, 100),
//				ConsistencyLevel.ONE);
//	
//		assertEquals(0, keys.size());
//
